    ...
    protected void onPostCreate(Bundle savedInstanceState){
        ...
        w.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.toLowerCase().startsWith("http://sine.adolfintel.com/forum") || url.toLowerCase().startsWith("http://isochronic.io/forum") || url.toLowerCase().startsWith("http://isochronic.io/uploads")||url.toLowerCase().startsWith("https://isochronic.io/forum") || url.toLowerCase().startsWith("https://isochronic.io/uploads")|| url.toLowerCase().startsWith("http://sine.fdossena.com/forum") || url.toLowerCase().startsWith("http://sine.fdossena.com/uploads")||url.toLowerCase().startsWith("https://sine.fdossena.com/forum") || url.toLowerCase().startsWith("https://sine.fdossena.com/uploads")) return false;
                if (url.toLowerCase().startsWith("http://sine.adolfintel.com/goto.php") || url.toLowerCase().startsWith("http://sine.adolfintel.com/presets.php") || url.toLowerCase().startsWith("http://isochronic.io/goto.php") || url.toLowerCase().startsWith("http://isochronic.io/presets.php")|| url.toLowerCase().startsWith("https://isochronic.io/goto.php") || url.toLowerCase().startsWith("https://isochronic.io/presets.php") || url.toLowerCase().startsWith("http://sine.fdossena.com/goto.php") || url.toLowerCase().startsWith("http://sine.fdossena.com/presets.php")|| url.toLowerCase().startsWith("https://sine.fdossena.com/goto.php") || url.toLowerCase().startsWith("https://sine.fdossena.com/presets.php")) { //link to a preset, or to the preset page
